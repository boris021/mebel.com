(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-hit")) new core(".swiper-hit", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            navigation: {
                prevEl: ".hit__body-arrow-prev",
                nextEl: ".hit__body-arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-collection")) new core(".swiper-collection", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("search-header__icon")) document.querySelector(".search-header").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelector(".search-form._active")) document.querySelector(".search-form").classList.remove("_active");
        }
    };
    isWebp();
    addTouchClass();
